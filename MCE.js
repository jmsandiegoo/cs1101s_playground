...
function evaluate(component, env) { 
    return is_literal(component)
           ...
           ? evaluate(logical_composition_to_conditional_expression(component), env)
...
function accum(component) {
    const res = accumulate(append,
                        null,
                        map(scan_out_declarations,
                            sequence_statements(component)));
    display_list(map(scan_out_declarations,
                            sequence_statements(component)));
    display_list(res);
    return res;
} 
